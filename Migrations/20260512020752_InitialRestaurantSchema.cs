        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApartmentSuite = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_DeliveryFields_MatchFulfillment", "((\"FulfillmentType\" = 'delivery' AND \"DeliveryAddressId\" IS NOT NULL AND \"DeliveryTypeId\" IS NOT NULL) OR (\"FulfillmentType\" = 'pickup' AND \"DeliveryAddressId\" IS NULL AND \"DeliveryTypeId\" IS NULL))");
                    table.CheckConstraint("CK_Orders_FulfillmentType", "\"FulfillmentType\" IN ('delivery', 'pickup')");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_RestaurantId_OrderedAt",
                table: "Orders",
                columns: new[] { "RestaurantId", "OrderedAt" });
